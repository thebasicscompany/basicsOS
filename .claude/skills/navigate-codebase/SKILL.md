...
| -------------- | ---------------------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------ |
| Knowledge base | `context/modules/knowledge-base.context.md`                            | `packages/api/src/routers/knowledge.ts`    | `packages/db/src/schema/documents.ts` _(named documents, not knowledge)_ |
...
| Automations    | `context/modules/ai-employees.context.md` _(shared with AI Employees)_ | `packages/api/src/routers/automations.ts`  | `packages/db/src/schema/automations.ts`                                  |
