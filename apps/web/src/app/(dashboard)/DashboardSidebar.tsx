...
export function DashboardSidebar(): JSX.Element {
  ...
  const header = (
    <div className="flex items-center gap-3">
      <Link href="/" className="flex size-8 items-center justify-center rounded-sm bg-sidebar-primary" aria-label="Home">
  ...
  return (
    ...
    >
      <div className="px-2 py-3">
        <SectionLabel className="px-3 pb-2">Workspace</SectionLabel>
          ...
          {visibleItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={cn(
                  "relative flex w-full items-center gap-2 overflow-hidden rounded-sm px-2 py-2 text-sm outline-none transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
      ...
      <div className="px-2 py-3">
        <SectionLabel className="px-3 pb-2">Quick Actions</SectionLabel>
          ...
          {item.children.map((child) => {
            ...
            return (
              <Link
                ...
                href={child.href}
                className={cn(
                  "flex items-center gap-2 rounded-sm px-2 py-1.5 text-xs transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
