...
export declare const CRM_RESOURCES: readonly ["contacts", "companies", "deals", "contact_notes", "deal_notes", "tasks", "crm_users", "tags", "configuration", "automation_rules", "companies_summary", "contacts_summary"];
