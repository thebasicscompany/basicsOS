...
const TYPE_OPTIONS: TypeOption[] = [
  { key: "text", label: "Text", icon: Type, group: "standard" },
  { key: "long-text", label: "Long Text", icon: AlignLeft, group: "standard" },
  { key: "number", label: "Number", icon: Hash, group: "standard" },
  { key: "currency", label: "Currency", icon: DollarSign, group: "standard" },
  { key: "select", label: "Select", icon: List, group: "standard" },
  {
    key: "multi-select",
    label: "Multi Select",
    icon: ListChecks,
  ...
  { key: "status", label: "Status", icon: CircleDot, group: "standard" },
  { key: "checkbox", label: "Checkbox", icon: CheckSquare, group: "standard" },
  { key: "date", label: "Date", icon: Calendar, group: "standard" },
  { key: "timestamp", label: "Timestamp", icon: Clock, group: "standard" },
  { key: "rating", label: "Rating", icon: Star, group: "standard" },
  { key: "email", label: "Email", icon: Mail, group: "standard" },
  { key: "domain", label: "Domain", icon: Globe, group: "standard" },
  { key: "phone", label: "Phone", icon: Phone, group: "standard" },
  { key: "location", label: "Location", icon: MapPin, group: "standard" },
  { key: "user", label: "User", icon: User, group: "relational" },
  {
    key: "relationship",
    label: "Relationship",
    icon: Link2,
