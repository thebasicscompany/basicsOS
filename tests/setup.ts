...
vi.mock("@basicsos/db", () => ({
  ...
  tasks: { id: "id", tenantId: "tenantId", status: "status", priority: "priority", assigneeId: "assigneeId", sourceType: "sourceType", dueDate: "dueDate", createdAt: "createdAt", updatedAt: "updatedAt" },
  automations: { id: "id", tenantId: "tenantId", enabled: "enabled", triggerConfig: "triggerConfig", actionChain: "actionChain" },
  ...
  invites: { id: "id", tenantId: "tenantId", token: "token", email: "email", role: "role", acceptedAt: "acceptedAt", expiresAt: "expiresAt" },
  ...
  aiEmployeeOutputs: { id: "id", jobId: "jobId", requiresApproval: "requiresApproval", approvedAt: "approvedAt", approvedBy: "approvedBy" },
